...
pub const KNOWN_CAS: &[KnownCA] = &[
    ...
    KnownCA {
        id: "sslcom-ecc",
        name: "SSL.com (ECC)",
        directory_url: "https://acme.ssl.com/sslcom-dv-ecc",
        website: "https://www.ssl.com",
        eab_required: true,
        wildcard_supported: true,
        notes: "SSL.com ECDSA endpoint, requires EAB",
    },
    KnownCA {
        id: "google",
    ...
    KnownCA {
        ...
        eab_required: true,
        wildcard_supported: false,
        notes: "Google testing environment, requires EAB",
    },
    KnownCA {
        id: "actalis",
        name: "Actalis",
        ...
        eab_required: false,
        wildcard_supported: true,
        notes: "Free 90-day certificates, based in Italy",
    },
    KnownCA {
        id: "step",
    ...
    KnownCA {
        ...
        eab_required: false,
        wildcard_supported: true,
        notes: "Commercial CA, likely requires EAB in practice",
    },
    KnownCA {
        id: "globalsign",
        name: "GlobalSign",
        directory_url: "https://emea.acme.atlas.globalsign.com/directory",
        website: "https://www.globalsign.com",
        eab_required: false,
        wildcard_supported: true,
        notes: "Commercial CA, EAB may be required",
    },
    KnownCA {
        id: "litessl",
        name: "LiteSSL",
        directory_url: "https://acme.litessl.com/acme/v2/directory",
        website: "https://litessl.com",
        eab_required: false,
        wildcard_supported: false,
        notes: "",
    },
    KnownCA {
        ...
        eab_required: false,
        wildcard_supported: true,
        notes: "Domain Validation only, EAB may be required",
    },
    KnownCA {
        id: "sectigo-ev",
        name: "Sectigo EV",
        directory_url: "https://acme.sectigo.com/v2/EV",
        website: "https://sectigo.com",
        eab_required: false,
        wildcard_supported: false,
        notes: "Extended Validation, EAB may be required",
    },
    KnownCA {
        id: "sectigo-ov",
        name: "Sectigo OV",
        directory_url: "https://acme.sectigo.com/v2/OV",
        website: "https://sectigo.com",
        eab_required: false,
        wildcard_supported: false,
        notes: "Organization Validation, EAB may be required",
    },
];
